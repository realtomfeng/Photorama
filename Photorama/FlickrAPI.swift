...
struct FlickrAPI {
    ...
    static func photos(fromJSON data: Data, into context: NSManagedObjectContext) -> PhotosResult { //This gets called from the PhotoStore with the data to parse the data
        do {
            ...
            for photoJSON in photosArray {
                if let photo = photo(fromJSON: photoJSON, into: context) { //This calls the photo function to convert the parsed data into Photo objects
